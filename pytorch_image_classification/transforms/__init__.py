...
#return the statistics value of your custom dataset
def _get_dataset_stats(
    ...
    elif name == 'Self_Dataset': #MNIST as an example
        mean = np.array([0.1307])
        std = np.array([0.3081])
    elif name in ['MSTAR']:
        mean = [0.485, 0.456, 0.406]
