...
config.dataset.dataset_dir = '/remote-home/qwb/zym/AI_S/torch_classification/data/'
config.dataset.image_size = 32
config.dataset.n_channels = 3
config.dataset.n_classes = 3

config.model = ConfigNode()
# options:  mnist', 'imagenet'
# Use  mnist' for small input images
config.model.type = 'mnist'
...
config.model.resnet.depth = 110  # for mnist type model
...
config.model.resnet_preact.depth = 110  # for mnist type model
...
config.model.wrn.depth = 28  # for mnist type model
...
config.model.densenet.depth = 100  # for mnist type model
...
config.model.pyramidnet.depth = 272  # for mnist type model
...
config.model.resnext.depth = 29  # for mnist type model
...
config.model.shake_shake.depth = 26  # for mnist type model
...
config.model.se_resnet_preact.depth = 110  # for mnist type model
